...
<title>Editar Piloto - TransportesPro</title>
...
Actualiza la información del piloto.
...
<form
    method="POST"
    action="/admin/pilotos/{{ $piloto->id }}"
>
...
<option
    value="inactivo"
    {{ $piloto->estado == 'inactivo' ? 'selected' : '' }}
>
