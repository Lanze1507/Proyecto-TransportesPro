...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group mb-3">
            ...
            <select name="cliente_id" class="form-control">
                @foreach($clientes as $c)
                    <option value="{{ $c->id }}" {{ $viaje->cliente_id == $c->id ? 'selected' : '' }}>
                        {{ $c->nombre }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group mb-3">
            <label>Origen</label>
            <input name="origen" id="origen" class="form-control" placeholder="Ej: New York, USA" value="{{ $viaje->origen }}">
            <div id="origen-list" class="list-group"></div>
        </div>

        <div class="form-group mb-3">
            <label>Destino</label>
            <input name="destino" id="destino" class="form-control" placeholder="Ej: Puerto Barrios Guatemala" value="{{ $viaje->destino }}">
